     ...
     //Se verifica que el archivo contenga una secuencia valida
        try {
            if(fileName.contains("..")){
                throw new MiException("El archivo contiene una secuencia invalida");
            }
            if(file.getBytes().length > (1600 * 1600 )){
                throw new MiException("El archivo sobre pasa el limite maximo");
            ...
            throw new MiException("No se pudo cargar el archivo "+fileName);
        } 
